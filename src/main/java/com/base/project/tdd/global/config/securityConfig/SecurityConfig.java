package com.base.project.tdd.global.config.securityConfig;


import com.base.project.tdd.global.config.securityConfig.jwt.JwtAuthenticationCheckFilter;
import com.base.project.tdd.global.config.securityConfig.jwt.JwtAuthenticationEntryPoint;
import com.base.project.tdd.global.config.securityConfig.jwt.JwtTokenProvider;
...
public class SecurityConfig {
    ...
    private static final String[] PERMITTED_URLS = {
            "/api/member/signup", "/api/member/login", "/h2-console/**", "/api/test/success"
    };
